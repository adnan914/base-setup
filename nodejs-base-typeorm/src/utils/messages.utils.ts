export class MessageUtil {
  ...
  static readonly DB_CONNECTION_ERROR = "Error during database connection!";
  static readonly DB_CONNECTION = "Database connection established successfully!";
  static readonly INVALID_SCHEMA_TYPE = "Invalid schema type";
  static readonly ENV_NOT_FOUND = "is not defined in the environment";
}
